defmodule StartingTemplate.AccountsTest do
  use StartingTemplate.DataCase

  alias StartingTemplate.Accounts

  describe "roles" do
    alias StartingTemplate.Accounts.Role

    @valid_attrs %{can_manage_users: true, can_modify_users: true, name: "some name"}
    @update_attrs %{can_manage_users: false, can_modify_users: false, name: "some updated name"}
    @invalid_attrs %{can_manage_users: nil, can_modify_users: nil, name: nil}
    ...
    test "create_role/1 with valid data creates a role" do
      ...
      assert role.can_manage_users == true
      assert role.can_modify_users == true
    ...
    test "update_role/2 with valid data updates the role" do
      ...
      assert role.can_manage_users == false
      assert role.can_modify_users == false
  ...
  describe "users" do
    alias StartingTemplate.Accounts.User
