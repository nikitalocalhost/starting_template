defmodule StartingTemplateWeb.Router do
  use StartingTemplateWeb, :router
  ...
  # scope "/api", StartingTemplateWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: StartingTemplateWeb.Telemetry
    end
  end
end
